...
/*
 ...
 구매이력이 없는 사용자도 출력하세요.
 */
 select userID, name, prodName, addr, concat(mobile1, mobile2)
 from usertbl u
...
union all -- 이승기의 중복!! 서울이기도하고 011 이기도해서!
